...
declare module 'goog:polymer.polymer.lib.mixins.gestureEventListeners' {

  import {dedupingMixin} from 'goog:polymer.polymer.lib.utils.mixin'; // from //third_party/javascript/polymer/v2/polymer

  import * as gestures$0 from 'goog:polymer.polymer.lib.utils.gestures'; // from //third_party/javascript/polymer/v2/polymer
