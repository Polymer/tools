...
declare module 'goog:polymer.polymer.lib.elements.domModule' {

  import {resolveUrl, pathFromUrl} from 'goog:polymer.polymer.lib.utils.resolveUrl'; // from //third_party/javascript/polymer/v2/polymer
