 ...
 * To make changes to browser.js, please edit the source files in the repo's
 * `browser/` directory!
 */
...
(function () {
   ...
   */
  var _config = {
    environmentScripts: ['mocha/mocha.js'],
    environmentImports: [],
    root: null,
  ...
  var MultiReporter = /** @class */ (function () {
     ...
     */
    MultiReporter.prototype.emitOutOfBandTest = function (
      title, error, suiteTitle, estimated) {
  ...
  function _ensureMocha() {
    ...
    if (!Mocha) {
      throw new Error(
        'WCT requires Mocha. Please ensure that it is present in WCT.environmentScripts, or that you load it before loading wct-mocha.js');
    }
    injectMocha(Mocha);
