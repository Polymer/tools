...
const ruleId = 'paper-input-v1-to-v2';
...
suite(ruleId, () => {
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`,
      `
  <paper-input value="hello world">
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`,
      `
  <paper-input-container><input is="iron-input" slot="input" id="myId"></paper-input-container>
  ~~~~~~~~~~~~~~~~~~~~~~~`,
      `
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~`,
      `
      <paper-textarea id="input" value="some random text"></paper-textarea>
      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`,
    ]);

    assert.deepEqual(warnings.map((w) => w.message), [
      `<paper-input> does not have attribute \`use-v2-underline\`.`,
      `<paper-input> does not have attribute \`use-v2-underline\`.`,
      `<paper-input> does not have attribute \`use-v2-underline\`.`,
      `<paper-input-container> does not have attribute \`use-v2-underline\`.`,
      `<paper-input-container> does not have attribute \`use-v2-underline\`.`,
      `<paper-textarea> does not have attribute \`use-v2-underline\`.`,
    ]);
  });
