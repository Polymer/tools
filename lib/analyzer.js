  ...
  if (this.loader) {
    ...
    parsed.import.forEach(function(link) {
      ...
      if (linkurl) {
        ...
        depsLoaded.push(this._dependenciesLoaded(resolvedUrl, href));
      }
    }.bind(this));
  }
...
Analyzer.prototype._dependenciesLoaded = function _dependenciesLoaded(href, root) {
  var found = {};
  if (root !== undefined) {
    found[root] = true;
  }
  return this._dependencies(href, found).then(function(deps) {
 ...
 */
Analyzer.prototype._dependencies = function _dependencies(href, found) {
  if (found === undefined) {
    found = {};
    found[href] = true;
  }
  ...
  return this.load(href).then(function(htmlMonomer) {
    ...
    htmlMonomer.depHrefs.forEach(function(depHref){
      ...
      deps.push(depHref);
      found[depHref] = true;
      transitiveDeps.push(this._dependencies(depHref, found));
    }.bind(this));
