...
- `invalid-element-name`: Warns when using an invalid element name.
- `potential-element-naming-issue`: Warns when there are potential issues or conflicts with the element name.
